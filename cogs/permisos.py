...
class PermisosCog(commands.Cog):
    ...
    @app_commands.command(name="permitir", description="Otorga permiso a otro usuario para controlar tu Codespace")
    ...
    async def permitir(self, interaction: discord.Interaction, usuario: discord.Member):
        ...
        # Verificar que tenga codespace vinculado
        ...
        # No puede darse permiso a sí mismo
    ...
    @app_commands.command(name="revocar", description="Revoca el permiso de un usuario")
    ...
    @app_commands.command(name="permisos", description="Ver lista de usuarios autorizados")
    async def permisos_lista(self, interaction: discord.Interaction):
        ...
        if permisos:
            ...
            embed.add_field(name="Lista de Usuarios", value=usuarios_str, inline=False)
        else:
            embed.add_field(name="Lista de Usuarios", value="*Ninguno*", inline=False)
